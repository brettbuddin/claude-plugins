...
description: >-
  ...
  by the reviewer on an <output_directory>/reports/*.md file.
---
...
1. Glob for `<output_directory>/reports/*.md` in the working directory. If none exist, tell the user to run `/report` first and stop.
